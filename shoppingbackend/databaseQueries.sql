...
VALUES ('Surendhar', 'Sudharshan', 'ADMIN', true, '$2a$06$ORtBskA2g5Wg0HDgRE5ZsOQNDHUZSdpJqJ2.PGXv0mKyEvLnKP7SW	', 'ss@gmail.com', '8888888888');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Pradeep', 'Striker', 'SUPPLIER', true, '12345', 'ps@gmail.com', '9999999999');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Ragul', 'kk', 'SUPPLIER', true, '12345', 'rk@gmail.com', '7777777777');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Shakir', 'Alam', 'USER', true, '12345', 'sa@gmail.com', '7777777777');
...
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDDEF123DEFX', 'Honor View20', 'Huawei', 'A smart phone by Honor!', 32000, 2, true, 3, 1, 0, 0 );
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
...
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDABCXYZDEFM', 'Acer Predator', 'Acer', 'This is one of the best laptop series from dell that can be used!', 48000, 5, true, 1, 3, 0, 0 );
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDABCXYZDEFG', 'MI LED SmartTV', 'xiaomi', 'This is one of the best television series from Xiaomi that can be used!', 25000, 5, true, 2, 3, 0, 0 );
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDABCXYZDEFX', 'Samsung NU6100', 'Samsung', 'This is one of the best television series from Samsung that can be used!', 48000, 5, true, 2, 3, 0, 0 );VALUES ('PRDABCXYZDEFX', 'Dell Latitude E6510', 'dell', 'This is one of the best laptop series from dell that can be used!', 48000, 5, true, 1, 3, 0, 0 );
-- adding a supplier correspondece address
INSERT INTO address( user_id, address_line_one, address_line_two, city, state, country, postal_code, is_billing, is_shipping) 
VALUES (4, 'Ameerjan Street, choolaimedu', 'Near skywalk, 'Nungambakkam', 'Chennai', 'tamilnadu', 'India', '600094', true, false );
