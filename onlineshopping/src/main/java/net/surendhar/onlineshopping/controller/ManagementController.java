package net.surendhar.onlineshopping.controller;
...
import net.surendhar.onlineshopping.util.FileUtil;
import net.surendhar.onlineshopping.validator.ProductValidator;
import net.surendhar.shoppingbackend.dao.CategoryDAO;
import net.surendhar.shoppingbackend.dao.ProductDAO;
import net.surendhar.shoppingbackend.dto.Category;
