package net.surendhar.onlineshopping.handler;
...
import net.surendhar.onlineshopping.model.CheckoutModel;
import net.surendhar.onlineshopping.model.UserModel;
import net.surendhar.shoppingbackend.dao.CartLineDAO;
import net.surendhar.shoppingbackend.dao.ProductDAO;
import net.surendhar.shoppingbackend.dao.UserDAO;
import net.surendhar.shoppingbackend.dto.Address;
import net.surendhar.shoppingbackend.dto.Cart;
import net.surendhar.shoppingbackend.dto.CartLine;
import net.surendhar.shoppingbackend.dto.OrderDetail;
import net.surendhar.shoppingbackend.dto.OrderItem;
import net.surendhar.shoppingbackend.dto.Product;
